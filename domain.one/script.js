...
class LocalStorageManipulation {
    ...
    localStarageSet(win, method, object, objectKey, ) {
        win.postMessage(JSON.stringify({ method: method, obj: object, key: objectKey }), "*");
        /* window.onmessage = function (e) {
            if (e.srcElement.location.pathname !== "/D:/FrontEnd/js%20test%20exercises/task4/domain.one/index.html") {
                return;
            }
        }; */
    }
    localStarageGetOrRemove(win, method, objectKey) {
        win.postMessage(JSON.stringify({ method: method, key: objectKey }), "*");
